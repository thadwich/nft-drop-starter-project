...
const CandyMachine = ({ walletAddress }) => {
  ...
  const renderMintedItems = () => (
    <div className="gif-container">
      <p className="sub-text">Minted Bears</p>
  ...
  const renderDropTimer = () => {
    ...
    return <p>{`Bears Dropped on: ${machineStats.goLiveDateTimeString}`}</p>;
  };
  return (
    machineStats && (
      <div className="machine-container">
        {renderDropTimer()}
        <p>{`Bears Minted: ${machineStats.itemsRedeemed} / ${machineStats.itemsAvailable}`}</p>
          {/* Check to see if these properties are equal! */}
          {machineStats.itemsRedeemed === machineStats.itemsAvailable ? (
            <p className="sub-text">No more bears. for now...</p>
          ) : (
            <button
